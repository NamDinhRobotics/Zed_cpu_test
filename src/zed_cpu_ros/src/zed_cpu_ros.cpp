...
public:
   ...
   */
  StereoCamera(const std::string& device_name, int resolution, double frame_rate) : frame_rate_(30.0)
  {
...
public:
   ...
   */
  static void publishCamInfo(const ros::Publisher& pub_cam_info, sensor_msgs::CameraInfo& cam_info_msg, ros::Time now)
  {
   ...
   */
  static void correctFramerate(int resolution, double& frame_rate)
  {
